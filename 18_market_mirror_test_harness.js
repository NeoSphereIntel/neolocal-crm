/**
 * File: 18_market_mirror_test_harness.js
...
function runMarketMirrorPayloadAutoRetail() {
...
function runRepSupportSheetHtmlAutoRetail() {
  return testRepSupportSheetHtml_("auto_retail");
}

function runMarketMirrorPayloadHVAC() {
  return testMarketMirrorPayload_("hvac");
}

function runMarketMirrorHtmlHVAC() {
  return testMarketMirrorHtml_("hvac");
}

function runRepSupportSheetHtmlHVAC() {
  return testRepSupportSheetHtml_("hvac");
}

function runMarketMirrorPayloadRoofing() {
  return testMarketMirrorPayload_("roofing");
}

function runMarketMirrorHtmlRoofing() {
  return testMarketMirrorHtml_("roofing");
}

function runRepSupportSheetHtmlRoofing() {
